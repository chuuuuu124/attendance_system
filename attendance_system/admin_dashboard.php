...
<body>
    <div class="sidebar">
        <h2>ADMIN CENTER</h2>
        <a href="checkin_board.php" class="menu-item"><i class="fas fa-desktop me-2"></i> 即時簽到看板</a>
        ...
        <a href="logout.php" class="menu-item" style="margin-top: 50px;"><i class="fas fa-sign-out-alt me-2"></i> 安全登出系統</a>
    </div>
